optimalKinaseModal <- function() {
  modal(
    ...
    header = "LSP-OptimalKinase Library",
    size = "lg",
    p(
...
moaModal <- function() {
  modal(
    id = "modal_moa",
    header = "LSP-MoA Library",
    size = "lg",
    p(
      "The LSP_MoA library is a collection of compounds in the public domain that were selected based on criteria described in Moret et al. (2019)"
    ),
    p("< image placeholder >"),
    p(
